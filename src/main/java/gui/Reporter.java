...
public class Reporter extends JDialog {
     ...
     * @param cols  The number of text columns
     * @throws AssertionError title String can not be null
     * @throws AssertionError title String can not be empty
     * @throws AssertionError rows must at least be one
     * @throws AssertionError cols must at least be one
     */
     ...
     * @throws AssertionError can not set foreground to null color
     */
    @Override
     ...
     * @throws AssertionError can not set background to null color
     */
    @Override
     ...
     * @throws AssertionError can not set font to null font
     */
    @Override
     ...
     *
     * @param thisText the text to be added
     * @throws AssertionError can not append a null string
     */
