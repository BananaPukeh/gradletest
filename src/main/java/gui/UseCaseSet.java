...
public class UseCaseSet extends JFrame implements ActionListener {
     ...
     * @param newHandler this object will be handling all cases, must implement the
     *                   UseCaseHandler interface.
     * @throws AssertionError The title cannot be null
     * @throws AssertionError The title cannot be empty
     */
     ...
     *
     * @param useCaseName the name of the added usecase, which is also used to identify
     *                    the usecase.
     * @throws AssertionError A useCaseName cannot be null
     * @throws AssertionError A useCaseName cannot be empty
     */
     ...
     *
     * @param useCaseName the name of the usecase to disable.
     * @throws AssertionError A useCaseName cannot be null
     * @throws AssertionError A useCaseName cannot be empty
     */
